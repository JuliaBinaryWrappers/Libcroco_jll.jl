...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libcroco_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("57eb2189-7eb1-52c8-ac0e-99495f550b14"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Libcroco", artifacts_toml) for e in artifacts["Libcroco"]]
...
if best_platform === nothing
    @debug("Unable to load Libcroco; unsupported platform $(triplet(platform_key_abi()))")
else
