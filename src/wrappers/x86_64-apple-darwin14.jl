# Autogenerated wrapper script for Libcroco_jll for x86_64-apple-darwin14
export libcroco
...
const libcroco_splitpath = ["lib", "libcroco-0.6.3.dylib"]
...
const libcroco = "@rpath/libcroco-0.6.3.dylib"
